...
# copied from https://github.com/glennhickey/hgvm-graph-bakeoff-evaluations/blob/master/scripts/plotHeatmap.py
...
def plotHeatMap(inputArray, rowNames, colNames, outFile, leftTree = False, topTree = False,
    ...
    if leftTree is True:
        ...
        Z = sch.dendrogram(Y, orientation='left', color_threshold=100000)
        axdendro.set_xticks([])
        axdendro.set_yticks([])
